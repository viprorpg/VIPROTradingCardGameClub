...
TMPlugin.Card.AnimationDamage = +(TMPlugin.Card.Parameters['animationDamage'] || 1);
...
(function() {
  ...
  Game_CardBattle.prototype.updateAttackPhase = function() {
    ...
    this.addMessage(this._turn ? 2 : 1, TMPlugin.Card.AnimationDamage);
  ...
  Sprite_Card.prototype.update = function() {
    ...
    if (this._hide && !this._card.isHiding()) {
      this.open();
    }
  ...
  Window_DeckEditStatus.prototype.refresh = function() {
    ...
    if (this._card.id() > 0) {
      ...
      this.drawText(TMPlugin.Card.ParamNames[2], x,  lineHeight * 0,  width);
      ...
      if (this._card.type() === 4) {
        ...
        this.drawText(TMPlugin.Card.ParamNames[3], x,  lineHeight * 1,  width);
      ...
      this.drawText(this._card.cost(), x, lineHeight * 0, width, 'right');
      ...
      this.drawItemName(unitSkill, x2, lineHeight * 9 - 8,  width2);
      this.drawItemName(partySkill, x2, lineHeight * 12 - 8, width2);
      this.contents.fontSize = 16;
      unitSkill.description.split('\n').map(function(text, i) {
        this.drawText(text, x2, lineHeight * 10 - 16 + i * 20, width2);
      }, this);
      partySkill.description.split('\n').map(function(text, i) {
        this.drawText(text, x2, lineHeight * 13 - 16 + i * 20, width2);
      }, this);
    }
  };
